...
- [API Reference](https://docs.lineplanet.me/api-reference/client/windows/6.0/index.html)
...
- Choose the project `GroupVideoCall\GroupVideoCallMFC\GroupVideoCallMFC.sln`.

#### WinUI 3 project

- Choose the project `GroupVideoCall\GroupVideoCallWinUI3Cpp\GroupVideoCallWinUI3Cpp.sln`.
...
```bash
C:\git\planet-kit-quickstart-windows>python3 generate_access_token.py <YOUR_USER_ID>
...
#### MFC project
##### Group call join page
<img src="../images/GroupVideoCall/join_room_mfc.png"/>

##### Participant page
<img src="../images/GroupVideoCall/participant_mfc.png"/>

##### Request video of peer
<img src="../images/GroupVideoCall/request_peer_mfc.png"/>

#### WinUI 3 project
##### Group call join page
<img src="../images/GroupVideoCall/join_room_winui3.png"/>

##### Participant page
<img src="../images/GroupVideoCall/participant_winui3.png"/>

##### Request video of peer
<img src="../images/GroupVideoCall/request_peer_winui3.png"/>

## Troubleshooting

### Call connection issues

If the group call cannot be connected, please check [PlanetKit::EStartFailReason](https://docs.lineplanet.me/api-reference/client/windows/6.0/namespace_planet_kit.html#a73be4867198309af56252749a8a51ac2) and [PlanetKit::EDisconnectReason](https://docs.lineplanet.me/api-reference/client/windows/6.0/namespace_planet_kit.html#adcd793bf6e3b3f134925da037a9d60a4).

```cpp
// check PlanetKit::EStartFailReason
// src/GroupVideoCallController.cpp
....
