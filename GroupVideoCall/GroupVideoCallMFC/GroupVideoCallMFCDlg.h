...
// GroupVideoCallMFCDlg.h : header file
//
...
class CGroupVideoCallMFCDlg : public CDialogEx {
// Construction
public:
	CGroupVideoCallMFCDlg(CWnd* pParent = nullptr);	// standard constructor
	~CGroupVideoCallMFCDlg();

// Dialog Data
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_GROUPVIDEOCALLMFC_DIALOG };
#endif
...
private :
	...
	GroupVideoCallDlg* m_pGroupVideoCallDlg = nullptr;
